                ...
                <div className="verification-main">
                    <div className="container verify-screen-main p-0">
                        ...
                        <div className="verify-section-main align-items-stretch">
                            ...
                            <p className="trouble">If you face any trouble for item ordering feel free to contact us.</p>
                            <div className="contact-us-text">
                                <div className="contact-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none">
                                        <mask id="mask0_3_1198"  maskUnits="userSpaceOnUse" x="0" y="0"
                                            width="24" height="24">
                                        ...
                                        <g mask="url(#mask0_3_1198)">
                                            <path
                                                ...
                                                stroke="#00D061" strokeWidth="2" strokeMiterlimit="10" />
                                            ...
                                            <path d="M22 9C22 5.13 18.87 2 15 2" stroke="#00D061" strokeWidth="2"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                        </g>
                                    </svg>
                                </div>
                                <a href="tel:+12223334455">+91 9515004433</a>
                            </div>
                            <div className="contact-us-text">
                                <div className="contact-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        <g>
                                            <path
                                                ...
                                                stroke="#00D061" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M17 9L13.87 11.5C12.84 12.32 11.15 12.32 10.12 11.5L7 9" stroke="#00D061"
                                                strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                        </g>
                                    </svg>
                                </div>
                                <a href="mailto:help@payfast.com">ayushkumarpanigrahi@gmail.com</a>
                            </div>
                            <div className="contact-us-text email-me">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        <g>
                                            <path
                                                ...
                                                stroke="#00D061" strokeWidth="2" strokeLinecap="round"
                                                strokeLinejoin="round" />
                                            <path d="M3.60156 9H20.4016" stroke="#00D061" strokeWidth="2"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M3.60156 15H20.4016" stroke="#00D061" strokeWidth="2"
                                                strokeLinecap="round" strokeLinejoin="round" />
                                            <path
                                ...
                                <a href="https:www.ayushkumarpanigrahi.info">www.ayushkumarpanigrahi.info</a>
                            </div>
                        </div>
                    </div>
                </div>
