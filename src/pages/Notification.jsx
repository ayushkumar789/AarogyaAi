                ...
                <div className="verification-main">
                    <div className="container verify-screen-main p-0">
                        ...
                        <div className="verify-section-main align-items-stretch">
                            ...
                            <p className="today-text factor">Now Aarogya GPT has a Two-Factor Authentication. Try it now to make your
                                account more secure.
                            </p>
                            <div className="notification-security-box">
                                <div className="notification-security-box-sub">
                            ...
                            <p className="today-text factor">Now you can also connect Aarogya GPT with multiple MasterCard & Visa. Try
                                the service now.
                            </p>
                            <div className="notification-security-box">
                                <div className="notification-security-box-sub">
                            ...
                            <p className="today-text factor">Update Aarogya GPT now to get access to the latest features for easier in
